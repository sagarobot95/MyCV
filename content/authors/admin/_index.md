...
work:
  - position: Senior Research Engineer, Robotics
    ...
    company_url: 'https://www.a-star.edu.sg/artc'
    company_logo: ''
    date_start: 2021-07-01
    date_end: ''
    summary: |2-
      Responsibilities include:
      - Develop Autonomous Navigation Module for Mobile Robots
      - Develop Robot Operating System Modules for Automating Warehouse Operations
      - Deploy Robot Middleware Framwork for Robotic Fleet Management in local industries
      - Led Projects to deploy robotic solutions in local Pharma Manufactuing Plants
  - position: Research Engineer
    company_name: Nanyang Technological University
    company_url: 'https://www.ntu.edu.sg/eee/research/corporate-laboratories'
    company_logo: ''
    date_start: 2019-12-16
    date_end: 2021-06-30
    summary: |
      Responsibilities include:
      - Developed a heuristic simulation to optimize AGV fleet management for factory automation at DELTA Corporate Lab, NTU.
      - Enhanced precise vehicle localization through data collection, system staging, and real-world testing at INFINITUS Lab, NTU.
